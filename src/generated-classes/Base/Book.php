...
abstract class Book implements ActiveRecordInterface
{
    ...
    public function setYear($v)
    {
        ...
        if ($this->year !== null || $dt !== null) {
            if ($this->year === null || $dt === null || $dt->format("Y-m-d") !== $this->year->format("Y-m-d")) {
                $this->year = $dt === null ? null : clone $dt;
     ...
     * @return ObjectCollection|ChildComment[] List of ChildComment objects
     */
    public function getBooksJoinUser(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCommentQuery::create(null, $criteria);
