 ...
 *
 * @method     ChildUserQuery leftJoinBook_user($relationAlias = null) Adds a LEFT JOIN clause to the query using the Book_user relation
 * @method     ChildUserQuery rightJoinBook_user($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Book_user relation
 * @method     ChildUserQuery innerJoinBook_user($relationAlias = null) Adds a INNER JOIN clause to the query using the Book_user relation
 *
 * @method     ChildUserQuery leftJoinComment_user($relationAlias = null) Adds a LEFT JOIN clause to the query using the Comment_user relation
 * @method     ChildUserQuery rightJoinComment_user($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Comment_user relation
 * @method     ChildUserQuery innerJoinComment_user($relationAlias = null) Adds a INNER JOIN clause to the query using the Comment_user relation
 *
 * @method     ChildUserQuery leftJoinRating_user($relationAlias = null) Adds a LEFT JOIN clause to the query using the Rating_user relation
 * @method     ChildUserQuery rightJoinRating_user($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Rating_user relation
 * @method     ChildUserQuery innerJoinRating_user($relationAlias = null) Adds a INNER JOIN clause to the query using the Rating_user relation
 *
 * @method     ChildUserQuery leftJoinRead_user($relationAlias = null) Adds a LEFT JOIN clause to the query using the Read_user relation
 * @method     ChildUserQuery rightJoinRead_user($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Read_user relation
 * @method     ChildUserQuery innerJoinRead_user($relationAlias = null) Adds a INNER JOIN clause to the query using the Read_user relation
 *
...
abstract class UserQuery extends ModelCriteria
{
     ...
     */
    public function filterByBook_user($book, $comparison = null)
    {
        if ($book instanceof \Book) {
            ...
            throw new PropelException('filterByBook_user() only accepts arguments of type \Book or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Book_user relation
     *
     ...
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinBook_user($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Book_user');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'Book_user');
        }
    ...
    /**
     * Use the Book_user relation Book object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useBook_userQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinBook_user($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Book_user', '\BookQuery');
    }
     ...
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByComment_user($comment, $comparison = null)
    {
        if ($comment instanceof \Comment) {
            ...
            return $this
                ->useComment_userQuery()
                ->filterByPrimaryKeys($comment->getPrimaryKeys())
                ->endUse();
        } else {
            throw new PropelException('filterByComment_user() only accepts arguments of type \Comment or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Comment_user relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinComment_user($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Comment_user');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'Comment_user');
        }
    ...
    /**
     * Use the Comment_user relation Comment object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useComment_userQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinComment_user($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Comment_user', '\CommentQuery');
    }
     ...
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByRating_user($rating, $comparison = null)
    {
        if ($rating instanceof \Rating) {
            ...
            throw new PropelException('filterByRating_user() only accepts arguments of type \Rating or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Rating_user relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinRating_user($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Rating_user');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'Rating_user');
        }
    ...
    /**
     * Use the Rating_user relation Rating object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useRating_userQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinRating_user($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Rating_user', '\RatingQuery');
    }
     ...
     * @return ChildUserQuery The current query, for fluid interface
     */
    public function filterByRead_user($read, $comparison = null)
    {
        if ($read instanceof \Read) {
            ...
            throw new PropelException('filterByRead_user() only accepts arguments of type \Read or Collection');
        }
    }

    /**
     * Adds a JOIN clause to the query using the Read_user relation
     *
     * @param     string $relationAlias optional alias for the relation
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return $this|ChildUserQuery The current query, for fluid interface
     */
    public function joinRead_user($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        $tableMap = $this->getTableMap();
        $relationMap = $tableMap->getRelation('Read_user');
        ...
        if ($relationAlias) {
            ...
            $this->addJoinObject($join, 'Read_user');
        }
    ...
    /**
     * Use the Read_user relation Read object
     *
     * @see useQuery()
     *
     * @param     string $relationAlias optional alias for the relation,
     ...
     */
    public function useRead_userQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ->joinRead_user($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'Read_user', '\ReadQuery');
    }
