...
abstract class User implements ActiveRecordInterface
{
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks = new ObjectCollection();
        $this->collBooks->setModel('\Comment');
    }
    ...
    public function getBooks(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collBooks || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBooks) {
                ...
                $collBooks = ChildCommentQuery::create(null, $criteria)
                    ->filterByUser($this)
                    ->find($con);
    ...
    public function setBooks(Collection $books, ConnectionInterface $con = null)
    {
        /** @var ChildComment[] $booksToDelete */
        $booksToDelete = $this->getBooks(new Criteria(), $con)->diff($books);
        ...
        $this->booksScheduledForDeletion = clone $booksToDelete;
     ...
     * @return $this|\User The current object (for fluent API support)
     */
    public function addBook(ChildComment $l)
    {
        if ($this->collBooks === null) {
            $this->initBooks();
            $this->collBooksPartial = true;
    ...
    /**
     * @param ChildComment $book The ChildComment object to add.
     */
    protected function doAddBook(ChildComment $book)
    {
        $this->collBooks[]= $book;
        $book->setUser($this);
    }
    ...
    /**
     * @param  ChildComment $book The ChildComment object to remove.
     * @return $this|ChildUser The current object (for fluent API support)
     */
    public function removeBook(ChildComment $book)
    {
        if ($this->getBooks()->contains($book)) {
            $pos = $this->collBooks->search($book);
            $this->collBooks->remove($pos);
     ...
     * @return ObjectCollection|ChildComment[] List of ChildComment objects
     */
    public function getBooksJoinBook(Criteria $criteria = null, ConnectionInterface $con = null, $joinBehavior = Criteria::LEFT_JOIN)
    {
        $query = ChildCommentQuery::create(null, $criteria);
    ...
    public function initBooks($overrideExisting = true)
    {
        ...
        $this->collBooks = new ObjectCollection();
        $this->collBooks->setModel('\Rating');
    }
    ...
    public function getBooks(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collBooks || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBooks) {
                ...
                $collBooks = ChildRatingQuery::create(null, $criteria)
                    ->filterByUser($this)
                    ->find($con);
     ...
     * @return $this|\User The current object (for fluent API support)
     */
    public function addBook(ChildRating $l)
    {
        if ($this->collBooks === null) {
            $this->initBooks();
            $this->collBooksPartial = true;
    ...
    /**
     * @param ChildRating $book The ChildRating object to add.
     */
    protected function doAddBook(ChildRating $book)
    {
        $this->collBooks[]= $book;
        $book->setUser($this);
    }
    ...
    /**
     * @param  ChildRating $book The ChildRating object to remove.
     * @return $this|ChildUser The current object (for fluent API support)
     */
    public function removeBook(ChildRating $book)
    {
        if ($this->getBooks()->contains($book)) {
            $pos = $this->collBooks->search($book);
            $this->collBooks->remove($pos);
    ...
    public function getBooks(Criteria $criteria = null, ConnectionInterface $con = null)
    {
        ...
        if (null === $this->collBooks || null !== $criteria  || $partial) {
            if ($this->isNew() && null === $this->collBooks) {
                ...
                $collBooks = ChildReadQuery::create(null, $criteria)
                    ->filterByUser($this)
                    ->find($con);
     ...
     * @return $this|\User The current object (for fluent API support)
     */
    public function addBook(ChildRead $l)
    {
        if ($this->collBooks === null) {
            $this->initBooks();
            $this->collBooksPartial = true;
    ...
    /**
     * @param ChildRead $book The ChildRead object to add.
     */
    protected function doAddBook(ChildRead $book)
    {
        $this->collBooks[]= $book;
        $book->setUser($this);
    }
    ...
    /**
     * @param  ChildRead $book The ChildRead object to remove.
     * @return $this|ChildUser The current object (for fluent API support)
     */
    public function removeBook(ChildRead $book)
    {
        if ($this->getBooks()->contains($book)) {
            $pos = $this->collBooks->search($book);
            $this->collBooks->remove($pos);
