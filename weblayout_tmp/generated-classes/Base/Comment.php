...
abstract class Comment implements ActiveRecordInterface
{
    ...
    public function setBookId($v)
    {
        ...
        if ($this->book_id !== $v) {
            $this->book_id = $v;
            $this->modifiedColumns[CommentTableMap::COL_BOOK_ID] = true;
        }
    ...
    public function setTitel($v)
    {
        ...
        if ($this->titel !== $v) {
            $this->titel = $v;
            $this->modifiedColumns[CommentTableMap::COL_TITEL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CommentTableMap::translateFieldName('BookId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->book_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CommentTableMap::translateFieldName('Titel', TableMap::TYPE_PHPNAME, $indexType)];
            $this->titel = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CommentTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00') {
                $col = null;
            }
            $this->date = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CommentTableMap::translateFieldName('Text', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_BOOK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'book_id';
        }
        if ($this->isColumnModified(CommentTableMap::COL_TITEL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentTableMap::COL_BOOK_ID)) {
            $criteria->add(CommentTableMap::COL_BOOK_ID, $this->book_id);
        }
        if ($this->isColumnModified(CommentTableMap::COL_TITEL)) {
            $criteria->add(CommentTableMap::COL_TITEL, $this->titel);
        }
        if ($this->isColumnModified(CommentTableMap::COL_DATE)) {
    ...
    public function hashCode()
    {
        ...
        //relation comment_fk_38da1e to table user
        ...
        //relation comment_fk_be6c79 to table book
    ...
    {
        return (null === $this->getCommentId()) && (null === $this->getUserId()) && (null === $this->getBookId());
    }
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->user_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aUser->addComment_users($this);
             */
        }
    ...
    public function getBook(ConnectionInterface $con = null)
    {
        if ($this->aBook === null && ($this->book_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aBook->addComment_books($this);
             */
        }
    ...
    {
        if (null !== $this->aUser) {
            $this->aUser->removeComment_user($this);
        }
        if (null !== $this->aBook) {
            $this->aBook->removeComment_book($this);
        }
