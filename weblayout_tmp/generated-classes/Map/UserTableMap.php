...
class UserTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('UserId', 'Name', 'Pw', 'Role', ),
        self::TYPE_CAMELNAME     => array('userId', 'name', 'pw', 'role', ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID, UserTableMap::COL_NAME, UserTableMap::COL_PW, UserTableMap::COL_ROLE, ),
        self::TYPE_FIELDNAME     => array('user_id', 'name', 'pw', 'role', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('UserId' => 0, 'Name' => 1, 'Pw' => 2, 'Role' => 3, ),
        self::TYPE_CAMELNAME     => array('userId' => 0, 'name' => 1, 'pw' => 2, 'role' => 3, ),
        self::TYPE_COLNAME       => array(UserTableMap::COL_USER_ID => 0, UserTableMap::COL_NAME => 1, UserTableMap::COL_PW => 2, UserTableMap::COL_ROLE => 3, ),
        self::TYPE_FIELDNAME     => array('user_id' => 0, 'name' => 1, 'pw' => 2, 'role' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('pw', 'Pw', 'VARCHAR', true, 30, null);
        $this->addColumn('role', 'Role', 'TINYINT', true, null, null);
    } // initialize()
    ...
    {
        $this->addRelation('Book_user', '\\Book', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), null, null, 'Book_users');
        $this->addRelation('Comment_user', '\\Comment', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), null, null, 'Comment_users');
        $this->addRelation('Rating_user', '\\Rating', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), null, null, 'Rating_users');
        $this->addRelation('Read_user', '\\Read', RelationMap::ONE_TO_MANY, array('user_id' => 'user_id', ), null, null, 'Read_users');
    } // buildRelations()
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UserTableMap::COL_PW);
